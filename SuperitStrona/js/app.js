(() => {
    ...
    (() => {
        ...
        if (block) {
            ...
            function animateParticles(scrollY) {
                particles.forEach(((particle, index) => {
                    ...
                    const pulseFactor = Math.sin(scrollY / 50 + index) * 40;
        ...
        if (blockKofElements.length > 0) blockKofElements.forEach((blockKof => {
            ...
            window.addEventListener("scroll", (() => {
                if (window.scrollY > 320) triggerExplosion();
            }));
            createElements();
            ...
            form.addEventListener("submit", (function(e) {
                ...
                fetch("contact-form.php", {
                    ...
                    if (data.status === "success") {
                        ...
                        form.reset();
                    } else responseDiv.innerHTML = '<p style="color: red;">' + data.message + "</p>";
                })).catch((error => {
                    document.getElementById("form-response").innerHTML = '<p style="color: red;">error</p>';
