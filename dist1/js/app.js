(() => {
    ...
    document.querySelectorAll(".menu__link").forEach((function(element) {
        element.addEventListener("mouseenter", (function() {
            ...
            hoverText.style.transition = "width 0.4s ease, opacity 0.1s ease, border-right 0.4s ease, filter 0.4s ease, color 0.45s ease";
            element.classList.add("hover");
            element.classList.remove("unhover");
        }));
        element.addEventListener("mouseleave", (function() {
            const hoverText = element.querySelector(".hover-text");
            hoverText.style.transition = "opacity 0.7s ease, border-right 0.4s ease, width 0.4s ease";
